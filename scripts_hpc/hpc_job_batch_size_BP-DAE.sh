...
#SBATCH --job-name=batch_size_BP-DAE
...
python main.py --experiment "Experiment_DAE_Batch_Size" --repeats 1 --experiment_name "Experiment_DAE_Batch_Size" --dataset_folder "finetune_synthetic"
