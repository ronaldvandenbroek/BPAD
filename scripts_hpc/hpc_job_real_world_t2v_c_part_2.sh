...
python main.py --experiment "Experiment_Real_World_T2V_C" --repeats 1 --experiment_name "Experiment_Real_World_T2V_C_HPC_JOB" --dataset_folder "experiment_real_world_selected_models_part_2"
