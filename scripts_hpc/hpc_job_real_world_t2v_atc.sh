...
python main.py --experiment "Experiment_Real_World_T2V_ATC" --repeats 3 --experiment_name "Experiment_Real_World_T2V_ATC_HPC_JOB" --dataset_folder "experiment_real_world_selected_models"
